...
lang: en-US
description: Learn about platforms you can use to gather analytics and setup customizations about Metal L2.
---
...
The following guide lists platforms you can use to gather analytics and setup customizations about Metal L2.

## Envio

[Envio](https://envio.dev/?utm_source=metall2&utm_medium=partner-docs) is the data layer for blockchain apps. It gives Metal L2 developers the fastest, most flexible way to get real-time and historical onchain data, from a single GraphQL API to raw high-speed access, with managed hosting on Envio Cloud. On Metal L2, HyperIndex is powered by HyperSync for historical syncs up to 2000x faster than traditional RPC.

With Envio you get:

*   Auto-generated indexers from any verified contract with `pnpx envio init`
*   Event handlers in TypeScript, JavaScript, or ReScript
*   Real-time and historical data with reorg support and backfills at 30,000+ events/sec
*   Multichain data aggregation across EVM and non-EVM networks
*   Fully managed hosting on Envio Cloud, or self-host

Start building with [Envio HyperIndex](https://docs.envio.dev/docs/HyperIndex/overview?utm_source=metall2&utm_medium=partner-docs). Metal L2 is available on HyperSync at `https://metall2.hypersync.xyz`.

See Envio's [performance benchmarks](https://docs.envio.dev/docs/HyperIndex/benchmarking?utm_source=metall2&utm_medium=partner-docs).
...
[Dune Analytics](https://dune.com) allows anyone to create dashboards that present information about OP Chains (Metal L2, Base, and Zora are available). See [Dune Docs](https://dune.com/docs/) for more info.
