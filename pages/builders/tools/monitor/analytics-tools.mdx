...
[Envio](https://envio.dev/?utm_source=metall2&utm_medium=partner-docs) is a high-performance indexing framework that turns Metal L2 smart contract events into a queryable GraphQL API, with managed hosting on Envio Cloud. On Metal L2, HyperIndex is powered by HyperSync for historical syncs up to 2000x faster than traditional RPC.
